...
mod imp {
            ...
            self.unit_metric_togglebutton
                .connect_toggled(clone!(@weak obj => move |btn| {
                    ...
                    if (btn.get_active()) {
                        ...
                        self_.height_spin_button.set_value (Length::new::<inch>(self_.height_spin_button.get_value() as u32).get::<centimeter>().into());
                    } else {
                        ...
                        self_.height_spin_button.set_value (Length::new::<centimeter>(self_.height_spin_button.get_value() as u32).get::<inch>().into());
                    }
                }));
    ...
    impl libadwaita::subclass::application_window::AdwApplicationWindowImpl for HealthSetupWindow {}
}
